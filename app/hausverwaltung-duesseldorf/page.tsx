...
export const metadata: Metadata = {
  title: "Hausverwaltung Düsseldorf — Modern, Digital & Zuverlässig | einfach verwaltet.",
  description:
    "Professionelle Hausverwaltung in Düsseldorf: Mietverwaltung & WEG-Verwaltung ab €24/Einheit. Transparent, digital, immer erreichbar. Jetzt Angebot anfragen.",
  alternates: {
    canonical: "https://einfach-verwaltet.de/hausverwaltung-duesseldorf",
  },
  openGraph: {
    title: "Hausverwaltung Düsseldorf — einfach verwaltet.",
    description:
      "Moderne Hausverwaltung in Düsseldorf. Mietverwaltung & WEG-Verwaltung, digitale Kommunikation, transparente Abrechnung. Ab €24/Einheit.",
  },
};
...
const localStructuredData = {
  ...
  "@type": "LocalBusiness",
  name: "einfach verwaltet. — Hausverwaltung Düsseldorf",
  description:
    "Professionelle Hausverwaltung in Düsseldorf für Miet- und WEG-Immobilien. Digital, transparent, immer erreichbar.",
  url: "https://einfach-verwaltet.de/hausverwaltung-duesseldorf",
  areaServed: [
...
const faqStructuredData = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Was kostet eine Hausverwaltung in Düsseldorf?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Eine Hausverwaltung in Düsseldorf kostet typischerweise €22–38 pro Einheit und Monat. einfach verwaltet. bietet professionelle Hausverwaltung ab €24/Einheit inkl. Mieterbetreuung, Nebenkostenabrechnung und digitalem Portal. Angebot anfragen unter einfach-verwaltet.de/anfrage.",
      },
    },
    {
      "@type": "Question",
      name: "Welche Stadtteile in Düsseldorf betreut einfach verwaltet.?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "einfach verwaltet. betreut Immobilien in allen Düsseldorfer Stadtteilen — von der Altstadt und Carlstadt über Pempelfort, Derendorf, Flingern, Bilk bis nach Oberkassel, Niederkassel und Grafenberg. Auch das Umland ist abgedeckt.",
      },
    },
    {
      "@type": "Question",
      name: "Wie schnell kann einfach verwaltet. meine Düsseldorfer Immobilie übernehmen?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Gibt es Besonderheiten bei der WEG-Verwaltung in Düsseldorf?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Düsseldorfer WEG-Verwaltungen unterliegen dem Wohnungseigentumsgesetz (WEG) wie bundesweit üblich. Besonderheiten gibt es bei Denkmalschutzobjekten in der Altstadt, großen Wohnanlagen am Rhein und bei der Zusammenarbeit mit der Haus- und Grundstückseigentümervereinigung (HGVI) Düsseldorf.",
      },
    },
  ],
};
...
const features = [
  ...
  {
    icon: BuildingIcon,
    title: "Düsseldorfer Markt-Expertise",
    desc: "Düsseldorfer Mietspiegel, Rheinlage, Denkmalschutz — wir kennen die Besonderheiten der Landeshauptstadt NRW.",
  },
  {
    icon: ShieldIcon,
...
const leistungen = [
  ...
  "Mieterhöhungen nach Düsseldorfer Mietspiegel",
...
export default function HausverwaltungDuesseldorfPage() {
  return (
    <>
      <script
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-5">
                Hausverwaltung Düsseldorf —<br />
                <span className="text-teal">einfach verwaltet.</span>
              </h1>
              <p className="text-lg text-white/80 mb-8 leading-relaxed">
                Professionelle Mietverwaltung & WEG-Verwaltung für Immobilien in Düsseldorf und Umgebung. Digital, transparent, immer erreichbar — ab €24/Einheit/Monat.
              </p>
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl font-bold text-navy text-center mb-10">
              Warum einfach verwaltet. für Düsseldorf?
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                <h2 className="text-2xl font-bold text-navy mb-6">
                  Leistungen der Hausverwaltung Düsseldorf
                </h2>
                ...
                <div className="mt-8">
                  ...
                  >
                    Angebot für Düsseldorfer Immobilie
              ...
              <div>
                ...
                <p className="mt-4 text-xs text-text-light">
                  Und alle weiteren Düsseldorfer Stadtteile — digitale Prozesse ohne geografische Einschränkungen.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-[700px] mx-auto text-center">
            <h2 className="text-2xl font-bold text-navy mb-4">
              Hausverwaltung Düsseldorf Kosten
            </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-warm-white rounded-2xl p-6 border-2 border-gray-100 text-left">
                <h3 className="font-bold text-navy mb-1">Mietverwaltung Düsseldorf</h3>
              ...
              <div className="bg-navy rounded-2xl p-6 text-left">
                <h3 className="font-bold text-white mb-1">WEG-Verwaltung Düsseldorf</h3>
        ...
        <section className="py-16 px-6">
          <div className="max-w-[700px] mx-auto">
            <h2 className="text-2xl font-bold text-navy text-center mb-8">
              Häufige Fragen — Hausverwaltung Düsseldorf
            </h2>
            <div className="space-y-4">
              {[
                {
                  q: "Was kostet eine Hausverwaltung in Düsseldorf?",
                  a: "Eine professionelle Hausverwaltung in Düsseldorf kostet typischerweise €22–38 pro Einheit und Monat. einfach verwaltet. bietet Mietverwaltung ab €24/Einheit und WEG-Verwaltung ab €28/Einheit. Keine Mindestvertragslaufzeit, keine versteckten Gebühren.",
                },
                {
                  q: "Welche Stadtteile betreut einfach verwaltet. in Düsseldorf?",
                  a: "Wir verwalten Immobilien in allen Düsseldorfer Stadtteilen — von Altstadt und Carlstadt über Pempelfort, Derendorf und Flingern bis zu Oberkassel, Bilk und Grafenberg. Auch das gesamte Umland (Neuss, Ratingen, Mettmann) ist abgedeckt.",
                },
                {
                  q: "Wie funktioniert der Wechsel der Hausverwaltung in Düsseldorf?",
                ...
                {
                  q: "Was sind die Besonderheiten des Düsseldorfer Immobilienmarktes?",
                  a: "Düsseldorf zählt zu den attraktivsten Immobilienmärkten Deutschlands. Besondere Bedeutung haben Denkmalschutzobjekte in der Altstadt, hochpreisige Wohnlagen am Rhein und die Nähe zum Wirtschaftsstandort Köln. Der Mietspiegel liegt über dem NRW-Durchschnitt.",
                },
                {
                  q: "Gibt es Unterschiede bei der WEG-Verwaltung in Düsseldorf?",
                  a: "Düsseldorfer WEG-Verwaltungen unterliegen dem Wohnungseigentumsgesetz (WEG) wie bundesweit üblich. Besonderheiten gibt es bei Denkmalschutzobjekten in der Altstadt, großen Wohnanlagen am Rhein und bei der Zusammenarbeit mit der Haus- und Grundstückseigentümervereinigung (HGVI) Düsseldorf.",
                },
              ].map((faq, i) => (
        ...
        <section className="py-16 px-6 bg-navy">
          <div className="max-w-[600px] mx-auto text-center">
            <h2 className="text-2xl font-bold text-white mb-3">
              Düsseldorfer Immobilie abgeben?
            </h2>
