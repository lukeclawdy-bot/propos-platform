...
export const metadata: Metadata = {
  title: "Hausverwaltung Frankfurt — Modern, Digital & Zuverlässig | einfach verwaltet.",
  description:
    "Professionelle Hausverwaltung in Frankfurt am Main: Mietverwaltung & WEG-Verwaltung ab €24/Einheit. Transparent, digital, immer erreichbar. Jetzt Angebot anfragen.",
  alternates: {
    canonical: "https://einfach-verwaltet.de/hausverwaltung-frankfurt",
  },
  openGraph: {
    title: "Hausverwaltung Frankfurt — einfach verwaltet.",
    description:
      "Moderne Hausverwaltung in Frankfurt. Mietverwaltung & WEG-Verwaltung, digitale Kommunikation, transparente Abrechnung. Ab €24/Einheit.",
  },
};
...
const localStructuredData = {
  ...
  "@type": "LocalBusiness",
  name: "einfach verwaltet. — Hausverwaltung Frankfurt",
  description:
    "Professionelle Hausverwaltung in Frankfurt für Miet- und WEG-Immobilien. Digital, transparent, immer erreichbar.",
  url: "https://einfach-verwaltet.de/hausverwaltung-frankfurt",
  areaServed: [
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "Eine Hausverwaltung in Frankfurt kostet typischerweise €25–40 pro Einheit und Monat. einfach verwaltet. bietet professionelle Hausverwaltung ab €24/Einheit inkl. Mieterbetreuung, Nebenkostenabrechnung und digitalem Portal. Angebot anfragen unter einfach-verwaltet.de/anfrage.",
      },
    },
    {
      "@type": "Question",
      name: "Welche Stadtteile in Frankfurt betreut einfach verwaltet.?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "einfach verwaltet. betreut Immobilien in allen Frankfurter Stadtteilen — von der Innenstadt über Westend, Nordend, Sachsenhausen, Bornheim bis nach Niederrad, Bockenheim und Höchst. Auch das Rhein-Main-Gebiet ist abgedeckt.",
      },
    },
    {
      "@type": "Question",
      name: "Wie schnell kann einfach verwaltet. meine Frankfurter Immobilie übernehmen?",
      acceptedAnswer: {
        "@type": "Answer",
    ...
    {
      "@type": "Question",
      name: "Gibt es besondere Regelungen für Wohnungseigentümergemeinschaften in Frankfurt?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Frankfurter WEG-Verwaltungen unterliegen dem Wohnungseigentumsgesetz (WEG) wie bundesweit üblich. Besonderheiten gibt es bei großen WEGs in Hochhäusern der Bankenviertel und bei Denkmalschutzobjekten in der Altstadt. Wir berücksichtigen diese lokalen Besonderheiten.",
      },
    },
  ],
};
...
const features = [
  ...
  {
    icon: BuildingIcon,
    title: "Frankfurter Markt-Expertise",
    desc: "Mietspiegel Rhein-Main, Hochhausverwaltung, Bankenviertel — wir kennen die Besonderheiten der Mainmetropole.",
  },
  {
    icon: ShieldIcon,
...
const leistungen = [
  ...
  "Mieterhöhungen nach Frankfurter Mietspiegel",
...
export default function HausverwaltungFrankfurtPage() {
  return (
    <>
      <script
          ...
          <div className="max-w-[1100px] mx-auto">
            <div className="max-w-2xl">
              ...
              <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-5">
                Hausverwaltung Frankfurt —<br />
                <span className="text-teal">einfach verwaltet.</span>
              </h1>
              <p className="text-lg text-white/80 mb-8 leading-relaxed">
                Professionelle Mietverwaltung & WEG-Verwaltung für Immobilien in Frankfurt und dem Rhein-Main-Gebiet. Digital, transparent, immer erreichbar — ab €24/Einheit/Monat.
              </p>
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-[1100px] mx-auto">
            <h2 className="text-2xl font-bold text-navy text-center mb-10">
              Warum einfach verwaltet. für Frankfurt?
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                <h2 className="text-2xl font-bold text-navy mb-6">
                  Leistungen der Hausverwaltung Frankfurt
                </h2>
                ...
                <div className="mt-8">
                  ...
                  >
                    Angebot für Frankfurter Immobilie
              ...
              <div>
                ...
                <p className="mt-4 text-xs text-text-light">
                  Und alle weiteren Frankfurter Stadtteile — digitale Prozesse ohne geografische Einschränkungen.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-[700px] mx-auto text-center">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div className="bg-warm-white rounded-2xl p-6 border-2 border-gray-100 text-left">
                <h3 className="font-bold text-navy mb-1">Mietverwaltung Frankfurt</h3>
              ...
              <div className="bg-navy rounded-2xl p-6 text-left">
                <h3 className="font-bold text-white mb-1">WEG-Verwaltung Frankfurt</h3>
        ...
        <section className="py-16 px-6">
          <div className="max-w-[700px] mx-auto">
            <h2 className="text-2xl font-bold text-navy text-center mb-8">
              Häufige Fragen — Hausverwaltung Frankfurt
            </h2>
            <div className="space-y-4">
              {[
                {
                  q: "Was kostet eine Hausverwaltung in Frankfurt?",
                  a: "Eine professionelle Hausverwaltung in Frankfurt kostet typischerweise €25–40 pro Einheit und Monat. einfach verwaltet. bietet Mietverwaltung ab €24/Einheit und WEG-Verwaltung ab €28/Einheit. Keine Mindestvertragslaufzeit, keine versteckten Gebühren.",
                },
                {
                  q: "Welche Stadtteile betreut einfach verwaltet. in Frankfurt?",
                  a: "Wir verwalten Immobilien in allen Frankfurter Stadtteilen — von der Innenstadt, Westend und Nordend über Sachsenhausen und Bornheim bis zu Bockenheim, Niederrad und Höchst. Auch das gesamte Rhein-Main-Gebiet ist abgedeckt.",
                },
                {
                  q: "Wie funktioniert der Wechsel der Hausverwaltung in Frankfurt?",
                ...
                {
                  q: "Was sind die Besonderheiten des Frankfurter Immobilienmarktes?",
                  a: "Frankfurt zeichnet sich durch ein hohes Preisniveau, viele Hochhäuser im Bankenviertel und eine starke Nachfrage aus. Der Mietspiegel liegt deutlich über dem Bundesdurchschnitt. Besonders wichtig: Erfahrung mit Hochhausverwaltung und Denkmalschutzobjekten in der Altstadt.",
                },
                {
                  q: "Gibt es Unterschiede bei der WEG-Verwaltung in Frankfurt?",
                  a: "Frankfurter WEG-Verwaltungen unterliegen dem Wohnungseigentumsgesetz (WEG) wie bundesweit üblich. Besonderheiten gibt es bei großen WEGs in Hochhäusern und bei Denkmalschutzobjekten. Wir berücksichtigen diese lokalen Besonderheiten und haben Erfahrung mit Eigentümergemeinschaften aller Größen.",
                },
              ].map((faq, i) => (
