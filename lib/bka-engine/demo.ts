...
import { calculateBKA } from './calculator';
import { validateBKAInput, formatValidationResults, checkCostBalance } from './validator';
import { formatBKAStatement, formatBKASummary, formatCostsByCategory } from './formatter';
...
const costs: CostEntry[] = [
  {
    category: BKACostCategory.BETRIEBSSTROM,
    total_eur: 450.00,
  ...
  {
    category: BKACostCategory.WASSERVERSORGUNG,
    total_eur: 850.00,
  ...
  {
    category: BKACostCategory.ENTWAESSERUNG,
    total_eur: 620.00,
    allocation_key: AllocationKey.VERBRAUCH,
  ...
  {
    category: BKACostCategory.WARMWASSER,
    total_eur: 2100.00,
    allocation_key: AllocationKey.VERBRAUCH,
  ...
  {
    category: BKACostCategory.AUFZUG,
    total_eur: 1800.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.MUELLBeseITIGUNG,
    total_eur: 780.00,
    allocation_key: AllocationKey.PERSONENZAHL,
    description: 'Abfallentsorgung',
    vendor: 'Stadtreinigung Hamburg'
  },
  {
    category: BKACostCategory.STRASSENREINIGUNG,
    total_eur: 120.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.GARTENPFLEGE,
    total_eur: 690.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.BELEUCHTUNG,
    total_eur: 150.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.SCHORNSTEINREINIGUNG,
    total_eur: 180.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.VERSICHERUNG,
    total_eur: 520.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.HAUSMEISTER,
    total_eur: 2400.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.INSTANDHALTUNG,
    total_eur: 320.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.INSTANDSETZUNG,
    total_eur: 800.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.SCHOENHEITSREPARATUREN,
    total_eur: 0.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.TV_EMPFANG,
    total_eur: 360.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  {
    category: BKACostCategory.VERMIETUNGSKOSTEN,
    total_eur: 0.00,
    allocation_key: AllocationKey.WOHNFLAECHE,
  ...
  },
  {
    ...
    total_eur: 180.00,
    allocation_key: AllocationKey.EINHEIT,
...
console.log('-'.repeat(60));
const validationWarnings = validateBKAInput(bkaInput);
console.log(formatValidationResults(validationWarnings));
console.log('');

const balance = checkCostBalance(costs, vorauszahlungen);
...
console.log('\n');
console.log(formatCostsByCategory(bkaResult));
...
for (const unitResult of bkaResult.unitResults) {
  const statement = formatBKAStatement(unitResult, property, bkaResult);
...
console.log('='.repeat(80));
console.log(formatBKASummary(bkaResult));
